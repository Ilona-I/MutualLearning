...
function getSelectedType() {
  if (document.getElementById("inlineRadio2ArticleTypeArticle").checked
      === 'checked') {
    return "article";
  }
  if (document.getElementById("inlineRadio3ArticleTypeQuestion").checked
      === 'checked') {
    return "question";
  }
  return "all";
...
function getOwnerType() {
  if (document.getElementById("inlineRadio2OwnerOwn").checked === 'checked') {
    return "own";
  }
  if (document.getElementById("inlineRadio3OwnerSaved").checked === 'checked') {
    return "saved";
  }
  return "all";
}
